...
function reverseString($kebalik){
    $kebolak = kebalikan($kebalik);
    echo $kebolak . "<br>";
}
// Hapus komentar di bawah ini untuk jalankan Code
reverseString("Rizky Madani");
